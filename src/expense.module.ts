...
import { ExpenseRepository } from './domain/expense/expense-repository.interface';
import { ExpensePrismaRepository } from './infrastructure/database/expense/expense-prisma.repository';

@Module({
	controllers: [ExpenseController],
	providers: [ExpenseService, PrismaService, ExpenseDomainService, { provide: 'ExpenseRepository', useClass: ExpensePrismaRepository }],
})
